...
def get_dashboard_data():
    if ALPACA_API_KEY == "SHU_YERGA_API_KEY_YOZING":
        ...
        try:
            ...
            if res.status_code == 200:
                ...
                for ticker, snap in data.items():
                    ...
                    # Finviz hiylasi: Agar bozor ochilgan bo'lsa Daily Open, yo'qsa Latest Trade olinadi.
...
if now_ny.date().weekday() >= 5 or now_ny.date() == datetime.date(2026, 4, 3):
